...
const Banner = () => {
    return (
       <div className='bg-[#F6F6F6]'>
             <div className='flex-col intertems-ce justify-center md:flex md:flex-row-reverse pb-20 md:pt-20 pt-10 md:gap-28 bg-[#F6F6F6] mx-6 md:mx-40 lg:mx-46'>
            ...
            <div className='mx-auto md:mx-0 text-center md:text-start '>
                ...
                <Link to='/login' className='bg-indigo-500 px-10 py-3 rounded-sm hover:bg-indigo-600 text-white text-md font-poppins '>Booking</Link>
            </div>
